            ...
            {!isLoading ? (
                <>
                    ...
                    <View style={{marginTop: 22}}>
                        ...
                        >
                            <View style={{marginTop: 22}}>
                                <View>
                                    ...
                                    />
                                    <TouchableOpacity onPress={firstPhocusSubscription} style={styles.button}>
                                        <Text style={styles.buttonText}>Sign up with entered payment method</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                            {!firstTimeCustomer ? (
                            ...
                            <View>
                                <TouchableOpacity onPress={() => setModal1Visible(!modal1Visible)} style={styles.button}>
                        ...
                        {!isActive ? (
                            <TouchableOpacity onPress={() => setModal1Visible(true)} style={styles.button}>
                                <Text style={styles.buttonText}>Sign up for Phocus Premium</Text>
                            </TouchableOpacity> ) : (
                            <>
                                <TouchableOpacity onPress={editPaymentInformation} style={styles.button}>
                                    <Text style={styles.buttonText}>Edit Existing Payment Information</Text>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={() => setModal2Visible(true)} style={styles.button}>
                                    <Text style={styles.buttonText}>Cancel my Phocus Premium Subscription</Text>
                                </TouchableOpacity>
                            </>
                        )}
                    </View>
